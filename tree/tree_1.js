...
window.onload = function init()
{
	...
	//gl.uniform4fv(colorLoc,[0,1,0,1]); //You can also change the color using this line
    gl.drawArrays( gl.TRIANGLES, 0, 9 );

	// body color
	gl.uniform4f(colorLoc, 0.5, 0.25, 0, 1); // color (R,G,B,A)
	//gl.uniform4fv(colorLoc,[0.5, 0.25, 0, 1]); //You can also change the color using this line
